...
namespace FunctionPoint
{
    public partial class MainForm : Form
    {
        ...
        {
            DIForm Calc_DI = new DIForm(this.textBox1.Text)
            {
                Dock = DockStyle.Fill, TopLevel = false, TopMost = true
            };
            this.pnlFormLoader.Controls.Add(Calc_DI);
            Calc_DI.Show();
            Calc_DI.DataSent += di_DataSent;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)//programming language combo box
        {
